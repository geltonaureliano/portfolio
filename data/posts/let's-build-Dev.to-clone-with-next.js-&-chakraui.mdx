...
> Github repo: [https://github.com/MA-Gelton/dev.to-clone](https://github.com/MA-Gelton/dev.to-clone)
    ...
    >
      <Container>
        <HStack spacing={4}>
          ...
          <Spacer />
          <HStack spacing={3}>
            <Button color="#fff" borderRadius="4px" bg="#3b49df" _hover={{ bg: '#323ebe' }}>
              Create a post
            </Button>
            <IconButton>
