...
- [Projects Page](https://mGelton.me/projects)
  In previous version, I had projects list on home page. Now I added separate page for projects. [Code](https://github.com/MA-Gelton/myPortfolio/blob/main/pages/projects.tsx)

- [Popular Articles](https://mGelton.me)
  Removed projects list from home page and added popular articles. [Code](https://github.com/MA-Gelton/myPortfolio/blob/main/components/home-page/PopularArticles.tsx)

- [Linked with Prisma ORM](https://www.prisma.io/)

- [Post Like Feature](https://mGelton.me/blog)
  Now user can like posts and posts likes will be updated in real time wrt dev.to posts likes. [Code](https://github.com/MA-Gelton/myPortfolio/blob/main/components/ui/LikeButton.tsx)

- [Dotted squares](https://mGelton.me)
  Updated layout by adding dotted squares on both sides of page(from left to right). [Code](https://github.com/MA-Gelton/myPortfolio/blob/main/components/layout/appLayout.tsx)
...
#### Website link: [ma-Gelton](https://mGelton.me)
